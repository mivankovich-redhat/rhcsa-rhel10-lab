...
export SERVERA_NAME="${SERVERA_NAME:-servera}"
export SERVERA_SSH_TARGET="${SERVERA_SSH_TARGET:-servera-lab}"
...
export SERVERB_NAME="${SERVERB_NAME:-serverb}"
export SERVERB_SSH_TARGET="${SERVERB_SSH_TARGET:-serverb-lab}"
